...
def yolo_loop_main():
    ...
    while not rospy.is_shutdown():
        ...
        if results and results[0].boxes is not None:
            for det in results[0].boxes:
                ...
                if cls == 0:  # basket
                    ...
                    local_block_error_x = cx - cx_frame
        ...
        with lock:
            ...
            block_error_x = local_block_error_x
...
# =========================
def yolo_loop_top():
    global top_seen, top_error_x, top_error_y, current_state
...
def control_loop(pub, lift_pub, claw_pub, state_pub, debug_pub):
    ...
    global block_error_x, top_error_y, basket_error_x
    global block_area, basket_area
    ...
    while not rospy.is_shutdown():
        ...
        debug_msg = (
            ...
            f"block_err_x={block_error_x}, top_err_y={top_error_y}, basket_err_x={basket_error_x} | "
